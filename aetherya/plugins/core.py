...
from aetherya.util import LocalProxy
from aetherya.util.timing import Eventual
from aetherya.util.stats import timed
from aetherya.plugins import BasePlugin as Plugin
from aetherya.plugins import CommandResponse
from aetherya.sql import init_db
...
from aetherya.models.guild import Guild, GuildBan
from aetherya.models.message import Command, Message
from aetherya.models.notification import Notification
from aetherya.plugins.modlog import Actions
...
class CorePlugin(Plugin):
    ...
    def dm_listener(self, event):
        from aetherya.util.images import get_dominant_colors_user
        global_admin = rdb.sismember('global_admins', event.author.id)
